  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="w-full flex items-center justify-center gap-2 border border-border rounded-lg px-4 py-2 text-sm font-medium hover:bg-muted/30 transition-colors bg-background text-foreground"
      >
